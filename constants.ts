...
export const DUMMY_ANSWERS: Record<string, Record<string, string[]>> = {
  // E
  'E01': { 'Q1': ['opt1'] }, // 예
  'E02': { 'Q1': ['opt2'] }, // 아니오
  'E03': { 'Q1': ['opt1'] }, // 예
...
export const DUMMY_QUANTITATIVE_DATA: QuantitativeData = {};

export const DUMMY_PERFORMANCE_DATA: PerformanceData = {
    "온실가스 배출량": { "2024": "150", "2023": "160", "2022": "175" },
    "에너지 사용량": { "2024": "300", "2023": "310", "2022": "330" },
    "폐기물 배출량": { "2024": "50", "2023": "55", "2022": "60" },
    "총 임직원 수": { "2024": "55", "2023": "52", "2022": "50" },
    "여성 임직원 수": { "2024": "15", "2023": "14", "2022": "12" },
    "산업재해 발생 건수": { "2024": "0", "2023": "1", "2022": "0" },
};
